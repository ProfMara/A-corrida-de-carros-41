class Game {
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      this.  mostrarBarradeCombustível();
      //this.playerMovendo = false;
      drawSprites();
    }
  }

  mostrarBarradeCombustível(){ 
    push();
    image(fuelImage,  width/2 -130, height - player.positionY -350, 20, 20 );
    strokeWeight(3);
    stroke("white");
    fill("green");
    //fazer o retângulo que representa o combustível
  ...
  getCarsAtEnd(){
    var ouvinte = database.ref("carsAtEnd");
    ouvinte.on("value", data=>{
  ...
  coletarCombustivel(index) {
    //se o carro colidir com o combustível
    cars[index - 1].overlap(fuels, function(collector, collected) {
      
      //definir o combustível para 185
